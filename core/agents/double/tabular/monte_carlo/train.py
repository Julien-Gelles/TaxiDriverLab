...
def train_agent(
    ...
    """
    Train MonteCarloAgent on the 2-passenger Taxi environment.
    update() buffers transitions; on_episode_end() processes returns and decays epsilon.
    ...
    for ep in range(num_episodes):
        ...
        # on_episode_end processes returns, updates Q-table, and decays epsilon
        ...
        if verbose and (ep + 1) % 100 == 0:
            w = min(100, ep + 1)
            print(f"[MonteCarlo] Ep {ep+1}/{num_episodes} | "

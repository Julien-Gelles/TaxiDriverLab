"""
Évaluation (test) pour l'agent heuristique sur Taxi-v3.
...
def test_agent(
    ...
    """
    Exécute num_episodes épisodes d'évaluation avec l'agent heuristique.

    Args:
        agent: HeuristicAgent à évaluer.
    ...
    if verbose:
        ...
        print(
            f"Evaluation (heuristic) over {num_episodes} episodes: "

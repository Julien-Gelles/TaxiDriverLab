"""
Evaluation (testing) for the DQN agent on Taxi-v4 environment.

Runs episodes with no exploration (greedy policy over the network's Q-values)
and returns evaluation metrics. Same interface as the tabular agents' test.py.
"""
...
def test_agent(
    ...
    epsilon is set to 0 during evaluation and restored afterwards.
